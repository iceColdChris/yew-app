        ...
        html! {
            <div class="todomvc-wrapper">
                ...
                <footer class="info">
                    ...
                    <p>{ "Written by " }<a href="https://github.com/DenisKolodin/"  rel="noreferrer" target="_blank">{ "Denis Kolodin" }</a></p>
                    <p>{ "Part of " }<a href="http://todomvc.com/"  rel="noreferrer" target="_blank">{ "TodoMVC" }</a></p>
                </footer>
            </div>
        }
    }
